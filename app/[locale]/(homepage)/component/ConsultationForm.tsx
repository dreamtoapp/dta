...
export default function ConsultationForm({ onSubmit }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-10 bg-white dark:bg-gray-900 rounded-2xl shadow-lg ring-1 ring-gray-100 dark:ring-gray-800" dir="rtl">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
        ...
        {/* RIGHT: Form */}
        <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-800 p-4 sm:p-6 rounded-xl">
          {sent ? (
            <div className="flex flex-col items-center justify-center gap-4 p-4 sm:p-6 text-center">
              <svg className="w-12 h-12 sm:w-16 sm:h-16" viewBox="0 0 24 24" fill="none" aria-hidden>
                <path d="M5 13l4 4L19 7" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <h4 className="text-lg sm:text-xl font-semibold">تم استلام طلب الاستشارة بنجاح!</h4>
              <p className="text-sm sm:text-base opacity-80">شكرًا لثقتك بنا 🙏، سيقوم فريقنا بمراجعة طلبك والتواصل معك خلال 48 ساعة عمل.</p>
              <p className="text-sm opacity-80 mt-2">في حال وجود ضغط على الطلبات وتأخرنا بالرد، يمكنك التواصل مباشرة عبر واتساب:</p>
              <p className="text-sm font-medium mt-1 flex items-center justify-center gap-2 flex-wrap">
                ...
                <span className="break-all">{process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '+966554113107'}</span>
              </p>
              <button
                onClick={() => {
                  setSent(false);
                ...
                className="mt-3 px-6 py-3 rounded-md bg-white border border-gray-200 text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors text-base min-h-[48px] w-full sm:w-auto"
              >
                أرسل طلب آخر
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={t('name')}
                    className={`w-full rounded-md border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base ${validationErrors.name ? 'border-red-500 focus:ring-red-500' : ''
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={t('email')}
                    className={`w-full rounded-md border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base ${validationErrors.email ? 'border-red-500 focus:ring-red-500' : ''
                      }`}
                  />
              ...
              {/* Phone and Service - Stack on mobile, side by side on larger screens */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    maxLength={10}
                    required
                    className={`w-full rounded-md border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base ${validationErrors.phone ? 'border-red-500 focus:ring-red-500' : ''
                      }`}
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full rounded-md border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base ${validationErrors.service ? 'border-red-500 focus:ring-red-500' : ''
                      }`}
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full rounded-md border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 min-h-[120px] text-base resize-y ${validationErrors.message ? 'border-red-500 focus:ring-red-500' : ''
                    }`}
                />
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-md bg-indigo-600 text-white px-6 py-3 font-medium shadow hover:brightness-105 disabled:opacity-60 text-base min-h-[48px]"
                >
                  {loading ? (
